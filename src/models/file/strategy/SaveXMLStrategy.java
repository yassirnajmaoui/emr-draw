...
public class SaveXMLStrategy implements SaveStrategy {
	...
	public void save(ShapeContainer shapeArray, ConnexionContainer connexionArray) {
		...
		FileNameExtensionFilter ft = new FileNameExtensionFilter( "xml Files", "xml" );
		...
		if (retrival == JFileChooser.APPROVE_OPTION) {
			try {
				...
				XMLEventWriter eventWriter = outputFactory.createXMLEventWriter(new FileOutputStream(saveBox.getSelectedFile()+".xml"));
